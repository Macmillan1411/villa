...
SECRET_KEY = 'django-insecure-5m6aj6*453!mdw(2(!1a-5os(obexrbe6o1mt#)d+znlkv9-m&'
...
STATICFILES_STORAGE = "django.contrib.staticfiles.storage.StaticFilesStorage" #by default change this to whitenoise before deployment
